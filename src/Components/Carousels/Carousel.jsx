...
const Carousel = (images) => {
    ...
    if(fotos !== undefined){
        console.log(filtImagen)
        filtImagen = fotos[carrusel-1]

        backImage = {        
            backgroundImage: 'url(' + filtImagen + ')',
    ...
    return(
        <CarouselDiv style = {backImage}>
            <Buttons onClick={leftButton}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
            ...
            {/* </Contenido> */}
            <Buttons onClick={rigthButton}><svg  xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
